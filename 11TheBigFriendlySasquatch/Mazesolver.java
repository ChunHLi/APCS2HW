...
public class Mazesolver{
    ...
    private MyPriorityQueue<OP> Frontier = new MyPriorityQueue<OP>();
	...
	while (true == true){
	    ...
	    OP current = Frontier.removeSmallest();
	    if (maze[current.getRow()][current.getCol()] == 'E'){
		placeHolder = current;
		break;
	    }
	    ...
	    if (maze[current.getRow() + 1][current.getCol()] == ' ' || maze[current.getRow() + 1][current.getCol()] == 'E'){
		OP nextMove = new OP(current.getRow() + 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow() + 1, current.getCol(), endx, endy) , current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
		
	    }
	    if (maze[current.getRow()][current.getCol() + 1] == ' ' || maze[current.getRow()][current.getCol() + 1] == 'E'){
		OP nextMove = new OP(current.getRow() + 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow(), current.getCol() + 1, endx, endy), current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
	    }
	    if (maze[current.getRow() - 1][current.getCol()] == ' ' || maze[current.getRow() - 1][current.getCol()] == 'E'){
		OP nextMove = new OP(current.getRow() - 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow() - 1, current.getCol(), endx, endy), current);
	    ...
	    if (maze[current.getRow()][current.getCol() - 1] == ' ' || maze[current.getRow()][current.getCol() - 1] == 'E'){
		OP nextMove = new OP(current.getRow(),current.getCol() - 1,current.getDistance() + 1,calculateDistanceFromEnd(current.getRow(), current.getCol() - 1, endx, endy), current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
	    }
	}
	Frontier.clear();
	...
	while (true == true){
	    ...
	    maze[current.getRow()][current.getCol()] = 'x';
	    if (maze[current.getRow() + 1][current.getCol()] == ' ' || maze[current.getRow() + 1][current.getCol()] == 'E'){
		OP nextMove = new OP(current.getRow() + 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow() + 1, current.getCol(), endx, endy) + current.getDistance() + 1, current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
	    }
	    if (maze[current.getRow()][current.getCol() + 1] == ' ' || maze[current.getRow()][current.getCol() + 1] == 'E'){
		OP nextMove = new OP(current.getRow() + 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow(), current.getCol() + 1, endx, endy) + current.getDistance() + 1, current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
	    }
	    if (maze[current.getRow() - 1][current.getCol()] == ' ' || maze[current.getRow() - 1][current.getCol()] == 'E'){
		OP nextMove = new OP(current.getRow() - 1,current.getCol(),current.getDistance() + 1,calculateDistanceFromEnd(current.getRow() - 1, current.getCol(), endx, endy) + current.getDistance() + 1, current);
	    ...
	    if (maze[current.getRow()][current.getCol() - 1] == ' ' || maze[current.getRow()][current.getCol() - 1] == 'E'){
		OP nextMove = new OP(current.getRow(),current.getCol() - 1,current.getDistance() + 1,calculateDistanceFromEnd(current.getRow(), current.getCol() - 1, endx, endy) + current.getDistance() + 1, current);
		Frontier.add(nextMove,nextMove.getDistanceFromEnd());
	    }
	}
	Frontier.clear();
    ...
    public int calculateDistanceFromEnd(int currentX, int currentY, int endX, int endY){
